      ...
      const loadMessages = async () => {
        try {
          ...
          const subscription = supabase
            ...
            .on('postgres_changes', 
              { event: 'INSERT', schema: 'public', table: 'messages', filter: `chat_id=eq.${selectedConversation.chat_id}` },
              (payload) => {
          ...
          const typingSub = supabase
            ...
            .on('postgres_changes',
              { event: 'UPDATE', schema: 'public', table: 'chat_participants', filter: `chat_id=eq.${selectedConversation.chat_id}` },
              (payload) => {
